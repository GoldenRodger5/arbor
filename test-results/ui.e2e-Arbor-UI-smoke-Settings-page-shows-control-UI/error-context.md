...
- Name: ui.e2e.test.ts >> Arbor UI smoke >> Settings page shows control UI
- Location: src/test/ui.e2e.test.ts:47:3
...
Locator: getByText('Settings & Control')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('Settings & Control')
...
- main [ref=e3]:
  - paragraph [ref=e4]:
    ...
    - generic [ref=e9]:
      - text: "ID:"
      - code [ref=e10]: "`iad1::57v2w-1776292661332-9f9991b91c7d`"
