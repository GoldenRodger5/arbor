...
- Name: ui.e2e.test.ts >> Arbor UI smoke >> Live feed renders + summary card visible
- Location: src/test/ui.e2e.test.ts:77:3
...
Locator: getByRole('heading', { name: 'Live Feed' })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Live Feed' })
...
- main [ref=e3]:
  - paragraph [ref=e4]:
    ...
    - generic [ref=e9]:
      - text: "ID:"
      - code [ref=e10]: "`iad1::dtl4h-1776292703288-a491cc88beb9`"
