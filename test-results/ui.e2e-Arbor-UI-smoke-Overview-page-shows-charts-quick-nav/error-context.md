...
- Name: ui.e2e.test.ts >> Arbor UI smoke >> Overview page shows charts + quick nav
- Location: src/test/ui.e2e.test.ts:19:3
...
- main [ref=e3]:
  - paragraph [ref=e4]:
    ...
    - generic [ref=e9]:
      - text: "ID:"
      - code [ref=e10]: "`iad1::mdphb-1776292629883-4f963b5f2680`"
