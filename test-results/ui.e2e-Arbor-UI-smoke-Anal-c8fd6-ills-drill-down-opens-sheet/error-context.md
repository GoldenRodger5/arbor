...
- Name: ui.e2e.test.ts >> Arbor UI smoke >> Analytics page shows timeframe pills + drill-down opens sheet
- Location: src/test/ui.e2e.test.ts:26:3
...
- main [ref=e3]:
  - paragraph [ref=e4]:
    ...
    - generic [ref=e9]:
      - text: "ID:"
      - code [ref=e10]: "`iad1::nwpb5-1776292640367-31677c9878d5`"
