...
- Name: ui.e2e.test.ts >> Arbor UI smoke >> Games page renders
- Location: src/test/ui.e2e.test.ts:72:3
...
Locator: getByRole('heading', { name: 'Games Intelligence' })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Games Intelligence' })
...
- main [ref=e3]:
  - paragraph [ref=e4]:
    ...
    - generic [ref=e9]:
      - text: "ID:"
      - code [ref=e10]: "`iad1::trddr-1776292692804-5b3912debd8a`"
