...
- Name: ui.e2e.test.ts >> Arbor UI smoke >> Trade review page renders
- Location: src/test/ui.e2e.test.ts:83:3
...
Locator: getByRole('heading', { name: 'Trade Review' })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Trade Review' })
...
- main [ref=e3]:
  - paragraph [ref=e4]:
    ...
    - generic [ref=e9]:
      - text: "ID:"
      - code [ref=e10]: "`iad1::224tn-1776292713770-047f1e4eb7ed`"
