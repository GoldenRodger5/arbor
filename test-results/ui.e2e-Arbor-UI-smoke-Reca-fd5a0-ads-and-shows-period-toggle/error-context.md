...
- Name: ui.e2e.test.ts >> Arbor UI smoke >> Recap page loads and shows period toggle
- Location: src/test/ui.e2e.test.ts:36:3
...
Locator: getByRole('heading', { name: 'Recap' })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Recap' })
...
- main [ref=e3]:
  - paragraph [ref=e4]:
    ...
    - generic [ref=e9]:
      - text: "ID:"
      - code [ref=e10]: "`iad1::vmzt8-1776292650848-161fb68a3a04`"
