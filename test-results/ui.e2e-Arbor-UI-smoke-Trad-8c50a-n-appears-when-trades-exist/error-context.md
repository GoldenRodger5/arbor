...
- Name: ui.e2e.test.ts >> Arbor UI smoke >> Trade history loads + swipe button appears when trades exist
- Location: src/test/ui.e2e.test.ts:65:3
...
Locator: getByRole('heading', { name: 'Trade History' })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Trade History' })
...
- main [ref=e3]:
  - paragraph [ref=e4]:
    ...
    - generic [ref=e9]:
      - text: "ID:"
      - code [ref=e10]: "`iad1::spvmx-1776292682319-e8dbabe94dc3`"
